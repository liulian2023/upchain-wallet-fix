...
public abstract class C {
    ...
    public static final String TICKER_API_URL = "https://api.binance.com";
    ...
    public static final String EXTRA_WALLET_LOGO = "wallet_logo";
    ...
    public static final String DAPP_DEFAULT_URL = "";
