...
//    }
    ...
    public static int dip2px(float dipValue) {
        float scale = MyApplication.getsInstance().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        float fontScale = MyApplication.getsInstance().getResources().getDisplayMetrics().scaledDensity;
