...
public class OnLineKeFuActivity extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.online_kefu;
    }

    @Override
    public void initToolBar() {
        CommonToolBarUtils.initToolbar(this,R.string.contact_us);
    }
    ...
    private void initProgressBar() {
        ...
        String onlineCustomer = SharePreferencesUtil.getString(CommonStr.ONLINE_SERVICE, "");
        ...
        if (requestCode == REQUEST_CODE_PERMISSION_CAMERA) {
            ...
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                new AlertDialog.Builder(mContext)
                        .setTitle(getString(R.string.no_camara))
                        .setMessage(getString(R.string.no_camara_tip))
