...
public class WalletDetailActivity extends BaseActivity {
    ...
    public static void startAty(Context context, ETHWallet ethWallet,boolean fromList){
    ...
    public static void startAtyForResult(Activity  context, ETHWallet ethWallet, boolean fromList,int requestCode){
        Intent intent = new Intent(context, ModifyPasswordActivity.class);
        intent.putExtra("ethWallet",ethWallet);
        intent.putExtra("fromList",fromList);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.rl_modify_pwd:// 修改密码
                ModifyPasswordActivity.startAtyForResult(WalletDetailActivity.this,ethWallet,MODIFY_PASSWORD_REQUEST);
                break;
