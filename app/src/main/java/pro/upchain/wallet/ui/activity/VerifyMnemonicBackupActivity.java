...
//        layoutManager.setAlignItems(AlignItems.STRETCH);
    ...
    public void configViews() {
        verifyBackupMenmonicWordsAdapter.setOnItemClickListener(new OnItemClickListener() {
            @Override
        ...
        verifyBackupSelectedMnemonicWordsAdapter.setOnItemClickListener(new OnItemClickListener() {
            @Override
