...
import tron.common.crypto.Hash;
import tron.common.crypto.SymmEncoder;
import tron.common.utils.Base58;
import tron.common.utils.ByteArray;
import tron.common.utils.TransactionUtils;
import tron.core.config.Parameter;
...
public class WalletManager {
    ...
    public static void initGRPC() {
        ...
        Context context = MyApplication.getsInstance();
...
//        FirebaseAnalytics.getInstance(context).logEvent("new_wallet", bundle);
    ...
    public static AssetIssueContract createAssetIssueContract(byte[] owner, String name, String abbr, long totalSupply, int trxNum, int icoNum,
    ...
    public static GrpcAPI.TransactionListExtention getTransactionsFromThis(byte[] address, int offset, int limit) {
        return rpcCli.getTransactionsFromThis(address, offset, limit);
    }

    public static GrpcAPI.TransactionListExtention getTransactionsToThis(byte[] address, int offset, int limit) {
